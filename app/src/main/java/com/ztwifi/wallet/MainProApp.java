...
public class MainProApp extends UserApp {
	...
	public void initApp() {
		...
		setGParamValue("APP_SETTINGS.MAIN_ACT_URL", "act://com.netted.wsoa.main.MainActivity/");
		setGParamValue("APP_SETTINGS.MAIN_ACT_URL",
				"act://com.netted.wsoa.main.MainActivity/?checkLogin=6");
		setGParamValue("APP_SETTINGS.MAIN_ACT_LOGIN_URL", "act://com.netted.wsoa.main.MainActivity/?checkLogin=5");
	...
	protected void initGlobalParams() {
		...
		SharedPreferences city_Pro = getSharedPreferences("CITY_INFO", Context.MODE_PRIVATE);
		globalParams.put("CUR_CITYNAME", city_Pro.getString("cur_city", "北京"));
		globalParams.put("CUR_CITYCODE", city_Pro.getString("cur_code", "1101"));
		globalParams.put("CUR_SHORTNAME", city_Pro.getString("cur_shortname", "京"));
		globalParams.put("CUR_PROVICENAME", city_Pro.getString("cur_provicename", "北京"));
		globalParams.put("CUR_PROVICECODE", city_Pro.getString("cur_provicecode", "Beijing"));
		globalParams.put("CUR_CITYGEOINFO", city_Pro.getString("cur_cityGeoInfo", "116397308,39916820,12"));
		globalParams.put("CUR_LOCATIONCITY", getSharePrefParamValue("CUR_LOCATIONCITY", ""));
